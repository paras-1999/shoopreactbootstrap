...
export class Quote extends Component {
    render() {
        return (
            <Container fluid className="text-center text-middle mt-4" style={{backgroundImage:`url("/images/1.jpg")` 
            ,backgroundPosition:' center', backgroundSize:' 100% 160%',padding: '3rem 12rem'}}>
                <img src="images/profile.png" className="rounded-circle" height="100px" width="100px" />
             <i className="fa fa-quote-left text-light text-start w-100 opacity-25" style={{fontSize:'24px'}}></i><br/>
              ...
              <p className="text-light mb-0">PARAS SAXENA</p>
